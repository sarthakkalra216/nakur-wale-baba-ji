...
// Homepage teaser — short intro only; the full life journey and Devi Ji
// content live on /about (behind the "Know More" button).
          ...
          >
            <Parallax offset={26}>
              <div className="relative rounded-3xl overflow-hidden aspect-[4/5] max-w-md mx-auto lg:mx-0">
                ...
                <ImageReveal fill>
                  <Image
                    src="/images/Nakud%20wale%20baba%20ji/photo2.jpg"
                    alt={t.about.imgAlt}
                    fill
